...
1. Edit `races.csv` in Excel or Notepad++
...
3. Enter: `https://YOUR_USERNAME.github.io/gt-calendar/gt-racing-calendar.ics`
4. Save
...
# → produces gt-racing-calendar.ics in the same directory
```
